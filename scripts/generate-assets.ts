...
const socialSvg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">${orb}
  ...
  <text x="76" y="238" fill="#f7f9fb" font-family="Arial,sans-serif" font-size="76" font-weight="750" letter-spacing="-4">Real SSH apps.</text>
...
const mobileScreenshot = `<svg xmlns="http://www.w3.org/2000/svg" width="750" height="1334" viewBox="0 0 750 1334">${orb}
  ...
  <text x="50" y="230" fill="#f7f9fb" font-family="Arial,sans-serif" font-size="60" font-weight="750">Real SSH apps.</text><text x="50" y="298" fill="#9ccfe2" font-family="Arial,sans-serif" font-size="60">Built with OpenTUI.</text>
