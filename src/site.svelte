  ...
  {#if section === 'home'}
    <section class="hero">
      ...
      <div class="hero-copy">
        ...
        <h1>Your terminal is<br /><em>the interface.</em><i class="cursor" aria-hidden="true"></i></h1>
...
│                                     │
└─────────────────────────────────────┘</pre>
        <button class="copy-command" onclick={copyCommand}>{copied ? 'copied!' : 'copy command'}</button>
      </div>
    </section>
